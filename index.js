  ...
  else if(randomNumber1 === 6) document.querySelector(".img1").setAttribute("src","images/dice6.png");
  ...
  else if(randomNumber2 === 6) document.querySelector(".img2").setAttribute("src","images/dice6.png");
